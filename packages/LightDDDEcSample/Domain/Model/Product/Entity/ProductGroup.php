...
use Packages\LightDDDEcSample\Domain\Model\Product\Entity\{Color, Size};
use Packages\LightDDDEcSample\Domain\Model\Product\VO\{ColorId, ColorName, ProductGroupId, ProductGroupName, SizeId, SizeName};
use Illuminate\Support\Collection;
use Packages\LightDDDEcSample\Domain\Model\Common\Price\VO\{Price, PriceTaxIn, TaxRate};
 ...
 * 
 */
class ProductGroup implements Arrayable
{
  use ViewModelTrait;
  /** @var ProductGroupId */
