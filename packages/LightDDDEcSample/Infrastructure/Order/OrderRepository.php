<?php
namespace Packages\LightDDDEcSample\Infrastructure\Order\Eloquent;

use Packages\LightDDDEcSample\Domain\Model\Order\Entity\{Order, OrderItem};
...
class OrderRepository implements IOrderRepository
{
  ...
  public function save(Order $order) : Order {
    ...
    \SessionRepository::forget('lightDddCartId');
    return $tmpOrder;
  }
