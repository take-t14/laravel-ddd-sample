<?php
namespace Packages\LightDDDEcSample\Infrastructure\Cart\Eloquent;
...
class CartRepository implements ICartRepository
{
  ...
  public function find() : ?Cart {
    if (!\SessionRepository::has('lightDddCartId')) {
      return null;
    }
    /** @var CartId $cartId */
    $cartId = \SessionRepository::get('lightDddCartId');
  ...
  public function save(Cart $cart) : Cart {
    ...
    \SessionRepository::put('lightDddCartId', $retCart->getCartId());
    return $retCart;
  }
}